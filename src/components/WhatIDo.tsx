        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building software solutions with a focus on clean code,
                performance, and real-world utility. Experienced in Java-based
                backend development and frontend web technologies.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>ANALYZE</h3>
              <h4>Data & AI-Powered Solutions</h4>
              <p>
                Leveraging data analysis, Power BI, and AI tools like prompt
                engineering to drive insights and automate workflows. Passionate
